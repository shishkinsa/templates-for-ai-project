...
Для эталонных эндпоинтов `/api/v1/health` и `/api/v1/examples` при нагрузке из [capacity.md](../../architecture/capacity.md) время ответа p95 не превышает целевого значения.
